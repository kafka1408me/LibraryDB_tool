...
HEADERS += \
    MyLog.h \
    changeconnectingsettings.h \
    mainwindow.h \
    sqlmodelwrapper.h \
    waitwidget.h

FORMS += \
    changeconnectingsettings.ui \
    mainwindow.ui \
    waitwidget.ui
...
CONFIG(debug, debug|release){
  DESTDIR = $${PWD}\\Library_DB_tool_debug
}else{
  DESTDIR = $${PWD}\\Library_DB_tool_release
}
...
#  copyToDestdir("$$(QTDIR)/bin/Qt5WebSockets.dll")
  ...
  copyToDestdir("$${PWD_WIN}\\config.txt")
}
